...
with col_sliders:
    ...
    # estilos para tooltips flotantes en los botones ℹ️
    st.markdown(
        '''
        <style>
        .tooltip-icon {
    ...
    def tooltip_icon_html(id_suffix: str, text: str) -> str:
        return f"""
        <div class='tooltip-icon' id='tooltip-{id_suffix}'>ℹ️
    ...
    if selected_row is None:
        ...
        def descr(label: str) -> str:
            DESCS = {
                'D_v': 'diseño vial: ancho de calles, conectividad e intersecciones.',
                'A_tp': 'acceso transporte público: buses, metro e intermodalidad.',
                'E_u': 'entorno urbano: mezcla de usos, soporte peatonal y micromovilidad.',
                'F_p': 'flujos de personas: intensidad de viajes y permanencias en la zona.',
            }
            return DESCS[label]
        ...
        with c2:
            st.markdown(
                tooltip_icon_html('Dv', descr('D_v')),
                unsafe_allow_html=True,
            )
        ...
        with c2:
            st.markdown(
                tooltip_icon_html('Atp', descr('A_tp')),
                unsafe_allow_html=True,
            )
        ...
        with c2:
            st.markdown(
                tooltip_icon_html('Eu', descr('E_u')),
                unsafe_allow_html=True,
            )
        ...
        with c2:
            st.markdown(
                tooltip_icon_html('Fp', descr('F_p')),
                unsafe_allow_html=True,
            )
